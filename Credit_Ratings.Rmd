...
It looks like that 365243 is the only explicit anomaly. For now, let's just replace this value with NaN. Later on, during the modelling I will impute NA and NaN with median.
...
formula <- TARGET ~ EXT_SOURCE_2_EXT_SOURCE_3 + EXT_SOURCE_1_EXT_SOURCE_2_EXT_SOURCE_3 +
  ...
  DAYS_LAST_PHONE_CHANGE + DAYS_EMPLOYED_PERCENT + DAYS_EMPLOYED + facts.names
```
